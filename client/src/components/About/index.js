    ...
    return (
        <section id='about' className='min-h-screen flex justify-center items-center px-2'>
            <div id='container' className='w-4/5 flex flex-col justify-center items-center'>
                ...
                <p className="drop-shadow-3xl z-10 animate-slider2 font-ROM font-bold text-c-white text-2xl laptop:text-4xl rounded-xl p-2 text-justify max-w-sm tablet:max-w-md laptop:max-w-lg">
                    The professional web developer you have been searching for.
                </p>
