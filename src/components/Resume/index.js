...
const Resume = ({ onClose }) => {
    return (
        <section id='resume' className='z-50 min-h-screen min-w-screen flex justify-center items-center bg-c-tblack w-full font-League fixed top-0 right-0 bottom-0 left-0'>
