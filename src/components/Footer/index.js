            ...
            <ul className='flex flex-col items-start space-y-5 p-2'>
                <li>
                    <a href='mailto:vmlujanjr@outlook.com' target='_blank'>
                        <img src={ EmailLogo } alt='email logo' className='hover:scale-110 w-[30px] h-[30px]' />
                    </a>
                </li>
                <li>
                    <a href='https://github.com/VMLujanJr' target='_blank'>
                        <img src={ GitHubLogo } alt='github logo' className='hover:scale-110 w-[30px] h-[30px]' />
                    </a>
                </li>
                <li>
                    <a href='https://www.linkedin.com/in/vmlujanjr/' target='_blank'>
                        <img src={ LinkedInLogo } alt='linkedin logo' className='hover:scale-110 w-[30px] h-[30px]' />
                    </a>
                </li>
            </ul>
        </footer>
